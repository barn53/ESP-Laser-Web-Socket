// Based on:
// https://github.com/arkypita/ESP8266-SerialWebSocket/blob/master/websocketserver/websocketserver.ino
...
void setup()
{
    ...
    WiFi.hostname("ESP_Laser_WebSocket");

    wifiManager.setDebugOutput(false);
    WiFiManagerParameter custom_text("<p>This is just a text paragraph</p>");
    wifiManager.addParameter(&custom_text);

    wifiManager.setCustomHeadElement("<h1>Custom Head Element!</h1>");

    wifiManager.autoConnect("ESP_Laser_WebSocket", "esplaser8266");
    // wifiManager.startConfigPortal("ESP_Laser_WebSocket", "esplaser8266");
    // QR-Code: WIFI:T:WPA;S:ESP_Laser_WebSocket;P:esplaser8266;H:;
